...
public class State {
	/*
	 * State class has three property: 1. Whether there is a task; 2. Current
	 * city of the agent and, if a task exists, the task departure city; 3. Task
	 * destination city; If property 1 is "false", property 2 and 3 are NULL.
	 */
	...
	// We use HashMap to store agent states, so we override hashCode and equals
	...
	public int hashCode() {
		...
		result = prime * result + ((taskFrom == null) ? 0 : taskFrom.hashCode());
