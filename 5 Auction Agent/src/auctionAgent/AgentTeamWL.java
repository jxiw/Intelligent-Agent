...
//		}
		...
		//mybid = mybid * propobality[task.pickupCity.id][task.deliveryCity.id];
		round++;
	...
	public List<Plan> plan(List<Vehicle> vehicles, TaskSet tasks) {
		...
		CentralizedPlan selectedPlan = pdplan.getBestPlan().cost() < pdpAlg.getBestPlan().cost() ? pdplan.getBestPlan(): pdpAlg.getBestPlan() ;
